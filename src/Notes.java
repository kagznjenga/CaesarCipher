...
public class Notes {
  /**
   * Main method that contains output statements.
   */
  public static void printNotes() {
    ...
    System.out.println("* Java has various inbuilt data types. \r\n" 
        ...
        + " * 3. int: By default, the int data type is a 32-bit signed 2's complement integer,\r\n" 
    ...
    System.out.println("A class that is derived from another class is called a subclass "
        ...
        + "class that includes some of the code that you want, \r\n" 
    ...
    System.out.println("Some of the things you can do in a subclass include:\n" 
        ...
        +   "* You can declare a field in the subclass with same name as the one in the superclass"
        + "thus hiding it (not recommended).\r\n" 
        + "* You can declare new fields in the subclass that are not in the superclass.\r\n" 
        + "* The inherited methods can be used directly as they are.\r\n" 
        + "* You can write a new instance method in the subclass that has same signature as the one"
    ...
    System.out.println("The sample car program below implements most functions of inheritance");
  }
}
